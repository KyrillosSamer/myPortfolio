  ...
  return (
    <section id="Contact" className="section py-5 px-5">
      <div className="container mx-auto text-center">
        {/* تحريك العنوان من اليسار إلى اليمين عند ظهوره كل مرة يتم فيها التمرير */}
        <motion.h2
          className="text-5xl font-bold text-gradient mb-10"
          initial={{ opacity: 0, x: -100 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: false, amount: 0.5 }} // ✅ يحدث مع كل تمرير
        >
          Contact Me
        </motion.h2>

        {/* تحريك الفورم من اليمين إلى اليسار عند ظهوره كل مرة يتم فيها التمرير */}
        <motion.form
